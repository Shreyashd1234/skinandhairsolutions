      ...
      <section className="bg-background py-24">
        <div className="container-x grid gap-14 lg:grid-cols-12">
          <div className="lg:col-span-7">
            <form
              onSubmit={onSubmit}
              className="rounded-3xl border border-foreground/10 bg-card p-8 md:p-10"
            >
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <Field
                  ...
                  name="concern"
                  type="text"
                  placeholder="e.g. Hair fall, Acne"
                  required
                />
              </div>
            ...
            <div className="rounded-3xl bg-secondary p-8">
              ...
              <ul className="mt-6 space-y-4 text-sm">
                <li className="flex gap-3">
                  <MapPin className="mt-0.5 h-4 w-4 text-primary" /> Tilakwadi, Belagavi, Karnataka
                  590006
                </li>
                <li className="flex gap-3">
                ...
                <li className="flex gap-3">
                  <Mail className="mt-0.5 h-4 w-4 text-primary" /> care@skinandhairsolutions.in
                </li>
                <li className="flex gap-3">
                  <Clock className="mt-0.5 h-4 w-4 text-primary" /> Mon – Sat · 10:00 – 19:30
                </li>
              </ul>
              ...
              <p className="mt-6 text-xs text-muted-foreground">
                For medical emergencies, please call your nearest hospital.
              </p>
            </div>
          </aside>
        </div>
